...
:: Android packaging
set AND_CERT_NAME="Mini-games"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\Minigames.p12
...
set IOS_PROVISION=cert\Minigames.mobileprovision
...
set APP_ID=air.Minigames

:: Output packages
set DIST_PATH=dist
set DIST_NAME=Minigames
